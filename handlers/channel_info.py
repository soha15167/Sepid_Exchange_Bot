...
def channel_rules_html() -> str:
    ...
    return (
        ...
        f"{_RTL}<b>۳) زمان‌بندی واریز (بانکی/آنی) و نحوهٔ پیگیری</b>\n"
        f"{_RTL}واریز یورو به حساب بانکی، با توجه به بانک مبدأ و بانک مقصد و همچنین فرآیندهای تسویه و پردازش بین‌بانکی، "
        f"ممکن است بین <b>۱ تا ۳ روز کاری</b> زمان‌بر باشد. این موضوع در برخی موارد حتی برای واریزهای <b>آنی/فوری</b> نیز صدق می‌کند "
        f"و زمان نهایی، لزوماً به معنای تأخیر از سوی طرفین نبوده و تابع روال‌های بانکی است.\n"
        f"{_RTL}<b>مبنای محاسبه، صرفاً «روز کاری»</b> است؛ لذا واریزهایی که در <b>روزهای تعطیل رسمی</b> یا <b>پایان هفته</b> "
        f"(از جمله <b>جمعه</b>) انجام شوند، ممکن است در <b>نخستین روز کاری پس از تعطیلات</b> (برای مثال <b>دوشنبه</b>) به حساب مقصد "
        f"واریز/قابل برداشت شوند. همچنین در صورت تداخل با چند روز تعطیل متوالی، زمان نشستن وجه به‌طور طبیعی به بعد از تعطیلات موکول خواهد شد.\n"
        f"{_RTL}در این بازه، لطفاً از <b>پیگیری‌های مکرر و بیش از حد</b> خودداری فرمایید؛ مدیریت مجموعه به‌صورت مستمر وضعیت تراکنش را "
        f"<b>در حال پیگیری</b> است و به محض دریافت نتیجه قطعی یا ثبت نهایی در حساب مقصد، اطلاع‌رسانی انجام می‌شود. "
        f"بدیهی است ملاک نهایی، <b>ثبت واریز در حساب مقصد</b> بوده و تأخیرهای ناشی از فرآیندهای بانکی/بین‌بانکی خارج از اختیار طرفین است.\n\n"
        f"{_RTL}<b>۴) ممنوعیت آیدی و شماره تماس در آگهی</b>\n"
        ...
        f"{_RTL}<b>۵) رفرنس و اشاره به ایران</b>\n"
        ...
        f"{_RTL}<b>۷) بعد از تأیید آگهی و تیک سبز</b>\n"
        ...
        f"{_RTL}<b>۸) پیشنهاد و آگهی متناسب با مقدار یورو</b>\n"
        ...
        f"{_RTL}<b>۹) پاسخ‌گویی به‌موقع</b>\n"
        ...
        f"{_RTL}<b>۱۰) کشور بانک در آگهی و مذاکره</b>\n"
...
def fee_schedule_html() -> str:
    ...
    return (
        ...
        f"{_RTL}• برای آگهی <b>تا ۵۰۰ یورو</b> (شامل ۵۰۰): <b>۲٫۵ یورو</b> کارمزد هر طرف\n"
        f"{_RTL}• برای آگهی <b>۵۰۱ یورو به بالا</b>: <b>نیم‌درصد (۰٫۵٪)</b> مبلغ یورو به‌عنوان کارمزد هر طرف\n\n"
