"""کارمزد معاملهٔ یورو — یک منبع برای آگهی، معاوضه و خلاصهٔ پیشنهاد.

پله‌ها (کارمزد به‌ازای هر طرف، یورو — بدون نصف کردن بین طرفین):
- ۱ تا ۵۰ یورو: ۱ یورو برای هر طرف
- ۵۱ تا ۵۰۰ یورو: ۲٫۵ یورو برای هر طرف
- بالای ۵۰۰ یورو: نیم‌درصد مبلغ آگهی برای هر طرف
